...
function loadproducts( products1 ){
    document.getElementById("items").innerHTML="";
        ...
        <div class="card-body">
        <img src="${result.image}" alt="productimage" width="70%" height:"70%"  class="card-img" style="box-shadow:0px 0px 10px 0.65px black; display:flex; justify-content: center; align-items:center;"/>
        </div>
